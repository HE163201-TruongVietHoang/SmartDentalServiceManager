  ...
  const confirmTransfer = async () => {
    ...
    try {
      await transferConversation(
        selectedConversation.conversationId,
        selectedReceptionist.userId
      );
      toast.success("Cuộc trò chuyện đã được chuyển sang lễ tân khác.");
      ...
      toast.error("Lỗi chuyển cuộc trò chuyện. Vui lòng thử lại sau.");
    }
  };
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  {(() => {
                    ...
                    const otherId =
                      selectedConversation.participant1Id === currentUser.userId
              ...
              {receptionists.map((rec) => (
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      selectedReceptionist?.userId === rec.userId
                        ? "#e8f5f3"
                        : "#fff",
                  }}
